...
def params_search(trial):
    with mirrored_strategy.scope():
        ...
        for i in range(int(num_dense_make-1)):
            l_make = layers.Dense(make_neuron, activation='relu')(l_make)
    ...
    loss, make_acc = cnn.evaluate(train_set, steps=STEPS_PER_EPOCH_TRAIN)
...
joblib.dump(study, 'optuna_trials/dense_make120.pkl')
